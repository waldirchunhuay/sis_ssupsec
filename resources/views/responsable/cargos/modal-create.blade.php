...
<div class="modal fade" id="modal-add-cargo" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{route('cargos.store')}}" method="POST" class="row g-3 needs-validation" novalidate>
          @csrf
          ...
          <div class="col-md-12">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control" name="cargo" value="{{old('cargo')}}" placeholder="Presidente(a)" id="validationCustom01" required >
